...
<head>
    ...
    <style>
        ...
        select {
            ...
            text-align: center; /* Centering text, including the placeholder */
        }
        ...
        #topic::placeholder {
            text-align: center; /* Centering placeholder text */
        }
...
<body>
    ...
    <div id="form1">
        <div class="by-topic">Generate MCQ Questions</div>
        <form action="mcq_result.php" method="POST">
            <input type="text" id="topic" name="topic" placeholder="Enter the topic" required>
            <div class="input-container">
                <input type="number" id="num_questions" placeholder="Number of Questions" name="num_questions" required>
